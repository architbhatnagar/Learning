package practice.Uber;

/*
Uber has several cabs.
The ith cab takes cabTripTime[i] minutes to complete any trip.
 Your task is to find the minimum time it will take Uber to get n trips completed with these cabs.
  You can assume that there is no waiting time in-between the trips.

Note:

Different cabs can take the trips simultaneously (at any time, there can be more than one cab with an ongoing trip)
